...
def get_dataset(args):
    ...
    if 'lexica' in args.dataset:
        trainset_dir = "vera365/lexica_dataset" if args.dataset == 'lexica' else args.dataset
        train_dataset = LexicaDataset( return_text="prompt", dataset_dir=trainset_dir, mode='train', input_transform=transform_train)

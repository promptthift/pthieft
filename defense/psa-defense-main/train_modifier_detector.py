        ...
        try:
            if (epoch + 1) % 5 == 0 and epoch != 0:
                torch.save({
                    ...
                    }, os.path.join(args.save_path, 'modifier_detector.ckpt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='output/PS_ckpt/')
    ...
    args.subject_path = "output/PS_ckpt/pred_subject.csv"

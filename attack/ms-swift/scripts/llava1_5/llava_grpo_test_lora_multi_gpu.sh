#!/bin/bash
#SBATCH --job-name=4gpu_mixed          
#SBATCH --output=llava_7b_grpo_2gpu_80_full_lora_4gpu_mixed.log           
#SBATCH --error=llava_7b_grpo_2gpu_80_full_lora_4gpu_mixed.log               
...
swift rlhf \
    ...
    --logging_steps 1 \
    --max_length 2048 \
    --output_dir /fred/oz339/zdeng/output/lora/mixed_4gpu \
    --warmup_ratio 0.05 \

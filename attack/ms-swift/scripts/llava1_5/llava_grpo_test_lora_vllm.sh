#!/bin/bash
#SBATCH --job-name=1gpu_mixed          
#SBATCH --output=llava_7b_grpo_2gpu_80_full_lora_gpu_mixed.log           
#SBATCH --error=llava_7b_grpo_2gpu_80_full_lora_gpu_mixed.log               
...
swift rlhf \
    ...
    --logging_steps 1 \
    --max_length 2048 \
    --output_dir /fred/oz339/zdeng/output/lora/mixed \
    --warmup_ratio 0.05 \
